...
坐标系, 是科学世界中最基础也最重要的概念之一. Ta 无处不在: 从物理建模到数据可视化, 从数学证明到生活中的找座位、导航定位. 然而, 遗憾的是, 它常常被“日用而不知”——我们使用 Ta, 却时常忽略 Ta 的存在与重要性. 
...
据我们所知, 这是目前第一个以 "坐标系" 为核心进行拟人化创作并开源发布的项目. 欢迎大家围绕坐标系展开创作、讨论与交流! 
